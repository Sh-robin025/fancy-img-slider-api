...
// show a red message below the input, 
// when user click search btn or press enter with empty input
// this feature added for bonus marks
...
// a loading spinner added, when data is load
//  this feature added for bonus marks
...
const createSlider = () => {
  ...
  `;
    ...
    if (duration <= 0) {
        alert("Dear user,you can't set zero(0) or negative timer ! pls try again... ")
    } else {
